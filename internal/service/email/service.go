...
func New(userService userservice.Service, repo Repository ,emailService EmailService) *Service {
	return &Service{emailSvc: emailService ,userSvc: userService ,repo: repo}
}
